...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'ipv6_config': {'type': 'list', 'ipv6_end_addr': {'type': 'str', }, 'ipv6_start_addr': {'type': 'str', }},
        'user_tag': {'type': 'str', },
        'ipv4_config': {'type': 'list', 'ipv4_start_addr': {'type': 'str', }, 'ipv4_end_addr': {'type': 'str', }},
        'ipv6_prefix_config': {'type': 'list', 'ipv6_prefix_to': {'type': 'str', }, 'count': {'type': 'int', }, 'ipv6_addr_prefix': {'type': 'str', }},
        'uuid': {'type': 'str', }
    })
    return rv
