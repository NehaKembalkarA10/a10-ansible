...
def get_argspec():
    ...
    rv.update({'ip_multiple_fields': {'type': 'list', 'ip_addr2_sub': {'type': 'str', }, 'ip_sub': {'type': 'str', }, 'ip_mask_sub': {'type': 'str', }},
        'uuid': {'type': 'str', },
        'name': {'type': 'str', 'required': True, },
        'user_tag': {'type': 'str', },
        'ipv6_multiple_fields': {'type': 'list', 'ipv6_mask_sub': {'type': 'int', }, 'ipv6_sub': {'type': 'str', }, 'ipv6_addr2_sub': {'type': 'str', }}
    })
    # Parent keys
    rv.update(dict(
