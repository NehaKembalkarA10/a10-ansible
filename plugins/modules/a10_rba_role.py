...
def get_argspec():
    ...
    rv.update({'default_privilege': {'type': 'str', 'choices': ['no-access', 'read', 'write']},
        'name': {'type': 'str', 'required': True, },
        'user_tag': {'type': 'str', },
        'rule_list': {'type': 'list', 'operation': {'type': 'str', 'choices': ['no-access', 'read', 'oper', 'write']}, 'object': {'type': 'str', }},
