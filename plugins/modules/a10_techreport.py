...
def get_argspec():
    ...
    rv.update({'max_logfile_size': {'type': 'dict', 'uuid': {'type': 'str', }, 'value': {'type': 'int', }},
        'uuid': {'type': 'str', },
        'max_partitions': {'type': 'dict', 'uuid': {'type': 'str', }, 'value': {'type': 'int', }},
        'interval': {'type': 'dict', 'uuid': {'type': 'str', }, 'value': {'type': 'int', }},
        'disable': {'type': 'bool', },
